...
# project = rf.workspace("northeastern-university-chrvx").project("x-ray-cw22o")
...
!zip -r /content/yolov5/zipped/valid_labels.zip /content/yolov5/runs/detect/exp2/labels/
!zip -r /content/yolov5/zipped/train_labels.zip /content/yolov5/runs/detect/exp/labels/
!zip -r /content/yolov5/zipped/test_labels.zip /content/yolov5/runs/detect/exp3/labels/

!zip -r /content/yolov5/zipped/valid_images.zip /content/yolov5/get_knee-3/valid/images/
!zip -r /content/yolov5/zipped/test_images.zip /content/yolov5/get_knee-3/test/images/
!zip -r /content/yolov5/zipped/train_images.zip /content/yolov5/get_knee-3/train/images/
